...
model_path = hf_hub_download(repo_id="anithajk/tourism-model", filename="best_tourism_pipeline.joblib")
...
# USER INPUT SECTION
# -------------------------------------------------------
Age = st.number_input("Age (Customer's age in years)", min_value=18, max_value=80, value=30)
...
MonthlyIncome = st.number_input("Monthly Income", min_value=1000, max_value=300000, value=50000)
